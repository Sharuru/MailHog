...
func RegisterFlags() {
	...
	flag.StringVar(&cfg.Hostname, "hostname", envconf.FromEnvP("MH_HOSTNAME", "MailTrap.Internal").(string), "Hostname for EHLO/HELO response, e.g. MailTrap.example")
